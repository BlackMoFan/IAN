...
const EvaluatePart= () => {
    ...
    return (
        <div className="grid justify-center h-screen grid-cols-12 gap-6 p-4 px-5 bg-white lg:px-48 flex-center place-items-center">
            <div className="grid w-full h-full col-span-12 p-4 text-center mb-9 lg:h-full bg-input-area place-items-center text-input-area-text sm:col-span-6 lg:col-span-7 rounded-2xl">
                <img 
